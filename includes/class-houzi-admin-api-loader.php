 ...
 */
if ( ! class_exists( 'Houzi_Admin_Api_Loader' ) ) {
	class Houzi_Admin_Api_Loader {
		 ...
		 * @since    1.0.0
		 * @access   protected
		 * @var      array    $actions    The actions registered with WordPress to run when the hooks are fired.
		 */
		protected $actions;
		 ...
		 * @since    1.0.0
		 * @access   protected
		 * @var      array    $filters    The filters registered with WordPress to run when the hooks are fired.
		 */
		protected $filters;
