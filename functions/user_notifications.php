<?php
if ( ! class_exists( 'AdminApiUserNotification' ) ) {
    class AdminApiUserNotification {
        ...
        public function __construct() {
            ...
            add_action( 'rest_api_init', function () {
                register_rest_route( 'houzez-admin-api/v1', '/all-notifications', array(
                    'methods' => 'POST',
                    'callback' => array( $this, 'get_user_notifications'),
                    'permission_callback' => '__return_true'
                ));

                register_rest_route( 'houzez-admin-api/v1', '/check-notifications', array(
                    'methods' => 'POST',
                    'callback' => array( $this, 'check_for_new_notifications'),
                    'permission_callback' => '__return_true'
                ));

                register_rest_route('houzez-admin-api/v1', '/delete-notification', array(
                    'methods' => 'POST',
