...
add_action('rest_api_init', function () {
    register_rest_route('houzez-admin-api/v1', '/all_threads', array(
        'methods' => 'GET',
        'callback' => 'getMessageThreadsFunction',
...
add_action('rest_api_init', function () {
    register_rest_route('houzez-admin-api/v1', '/delete_thread',
        array(
            'methods' => 'POST',
            'callback' => 'deleteMessageThreadFunction',
            'permission_callback' => '__return_true'
        )
    );
});
...
add_action('rest_api_init', function () {
    register_rest_route('houzez-admin-api/v1', '/start_thread',
        array(
            'methods' => 'POST',
            'callback' => 'startMessageThreadFunction',
            'permission_callback' => '__return_true'
        )
    );
});
...
add_action('rest_api_init', function () {
    register_rest_route( 'houzez-admin-api/v1', '/all_messages',
        array(
            'methods' => 'GET',
            'callback' => 'getThreadMessagesFunction',
            'permission_callback' => '__return_true'
        )
    );
});
...
add_action('rest_api_init', function () {
    register_rest_route('houzez-admin-api/v1', '/send_message',
        array(
            'methods' => 'POST',
            'callback' => 'sendMessageFunction',
            'permission_callback' => '__return_true'
        )
    );
});

function getMessageThreadsFunction()
{
...
function deleteMessageThreadFunction()
{
...
function startMessageThreadFunction()
{
...
function getThreadMessagesFunction()
{
