...
add_action('rest_api_init', function () {
    ...
    register_rest_route('houzez-admin-api/v1', '/document-types', array(
        'methods' => 'GET',
        'callback' => 'getDocumentTypesFunction',
        'permission_callback' => '__return_true'
    ));
    
    register_rest_route('houzez-admin-api/v1', '/verification-status', array(
        'methods' => 'GET',
        'callback' => 'getVerificationStatusFunction',
        'permission_callback' => '__return_true'
    ));
	
    
    register_rest_route('houzez-admin-api/v1', '/submit-verification', array(
        'methods' => 'POST',
        'callback' => 'submitVerificationRequestFunction',
        'permission_callback' => '__return_true'
    ));
    
    register_rest_route('houzez-admin-api/v1', '/submit-additional-info', array(
        'methods' => 'POST',
        'callback' => 'submitAdditionalInfoFunction',
        'permission_callback' => '__return_true'
    ));
    
    register_rest_route('houzez-admin-api/v1', '/verification-history', array(
        'methods' => 'GET',
        'callback' => 'getVerificationHistoryFunction',
        'permission_callback' => '__return_true'
    ));
    
    // Verification Requests (Admin only)
    register_rest_route('houzez-admin-api/v1', '/verification-requests', array(
        'methods' => 'GET',
        'callback' => 'getVerificationRequestsFunction',
        'permission_callback' => '__return_true'
    ));
    
    // Process Verification (Admin only)
    register_rest_route('houzez-admin-api/v1', '/process-verification', array(
        'methods' => 'POST',
        'callback' => 'processVerificationRequestFunction',
        'permission_callback' => '__return_true'
    ));
 ...
 */
function submitVerificationRequestFunction($request) {
 ...
 */
function submitAdditionalInfoFunction($request) {
 ...
 */
function processVerificationRequestFunction($request) {
 ...
 */
function getVerificationStatusFunction($request) {
 ...
 */
function getVerificationHistoryFunction($request) {
...
function getVerificationRequestsFunction($request) {
 ...
 */
function getDocumentTypesFunction() {
