...
add_filter('rest_prepare_houzez_agent', 'prepareAgentDataFunction', 10, 3);

function prepareAgentDataFunction($response, $post, $request)
{
...
add_filter('rest_prepare_houzez_agency', 'prepareAgencyDataFunction', 10, 3);

function prepareAgencyDataFunction($response, $post, $request)
{
  // $params = $request->get_params();
...
add_action( 'rest_api_init', function () {
  register_rest_route( 'houzez-admin-api/v1', '/contact-realtor', array(
    'methods' => 'POST',
    'callback' => 'contactRealtorFunction',
    'permission_callback' => '__return_true'
  ));
  register_rest_route( 'houzez-admin-api/v1', '/schedule-tour', array(
    'methods' => 'POST',
    'callback' => 'scheduleATourFunction',
    'permission_callback' => '__return_true'
  ));
  register_rest_route( 'houzez-admin-api/v1', '/contact-property-agent', array(
    'methods' => 'POST',
    'callback' => 'contactPropertyRealtorFunction',
    'permission_callback' => '__return_true'
  ));
  register_rest_route( 'houzez-admin-api/v1', '/add-new-agent', array(
    'methods' => 'POST',
    'callback' => 'addAgentFunction',
    'permission_callback' => '__return_true'
  ));
  register_rest_route( 'houzez-admin-api/v1', '/edit-an-agent', array(
    'methods' => 'POST',
    'callback' => 'editAgentFunction',
    'permission_callback' => '__return_true'
  ));
  register_rest_route( 'houzez-admin-api/v1', '/agency-all-agents', array(
    'methods' => 'GET',
    'callback' => 'allAgencyAgentsFunction',
    'permission_callback' => '__return_true'
  ));
  register_rest_route( 'houzez-admin-api/v1', '/delete-an-agent', array(
    'methods' => 'POST',
    'callback' => 'deleteAgentFunction',
    'permission_callback' => '__return_true'
  ));
});

function contactRealtorFunction($request){
  // agent_id
  // target_email
  // mobile
  // name
  ...
  if (!create_nonce_or_throw_errorFunction('contact_realtor_ajax', 'contact_realtor_nonce')) {
    return;
  }
...
function addAgentFunction($request){
  ...
  if (!create_nonce_or_throw_errorFunction('houzez-security-agency-agent', 'houzez_agency_agent_ajax_nonce')) {
    return;
  }
...
function editAgentFunction($request){
  if (! is_user_logged_in() ) {
    $ajax_response = array( 'success' => false, 'reason' => 'Please provide user auth.' );
    wp_send_json($ajax_response, 403);
    return; 
...
function deleteAgentFunction($request) {
  if (! is_user_logged_in() ) {
    $ajax_response = array( 'success' => false, 'reason' => 'Please provide user auth.' );
    wp_send_json($ajax_response, 403);
    return; 
  ...
  if (!create_nonce_or_throw_errorFunction('agent_delete_security', 'agent_delete_nonce')) {
    return;
  }
...
function scheduleATourFunction($request){
  // listing_id
  // property_title
  // property_permalink
  ...
  if (!create_nonce_or_throw_errorFunction('schedule_contact_form_ajax', 'schedule-contact-form-nonce')) {
    return;
  }
...
function contactPropertyRealtorFunction($request){
  // agent_id
  // target_email
  // mobile
  // name
  ...
  if (!create_nonce_or_throw_errorFunction('property_agent_contact_security', 'property_agent_contact_nonce')) {
    return;
  }
...
function allAgencyAgentsFunction($request) {
