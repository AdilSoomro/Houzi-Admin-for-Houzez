 ...
 * Feb 17, 2023
 */
if ( ! class_exists( 'AdminApiElevenSettings' ) ) {
class AdminApiElevenSettings {
	...
	public function __construct( $plugin_name, $version ) {
		...
		add_action( 'rest_api_init', function () {
			register_rest_route( 'houzez-admin-api/v1', '/eleven-config', array(
				'methods' => 'POST',
		...
		add_action( 'rest_api_init', function () {
			register_rest_route( 'houzez-admin-api/v1', '/create-eleven-nonce', array(
				'methods' => 'POST',
